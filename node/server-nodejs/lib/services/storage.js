...
class Storage extends Service {
     ...
     * @returns {Promise}
     */
    async createBucket(bucketId, name, fileSecurity, permissions, enabled, maximumFileSize, allowedFileExtensions, encryption, antivirus) {
        let path = '/storage/buckets';
        let payload = {};
     ...
     * @returns {Promise}
     */
    async updateBucket(bucketId, name, fileSecurity, permissions, enabled, maximumFileSize, allowedFileExtensions, encryption, antivirus) {
        let path = '/storage/buckets/{bucketId}'.replace('{bucketId}', bucketId);
        let payload = {};
        if (typeof bucketId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "bucketId"');
