...
class Storage extends Service
{
     ...
     */
    public function createBucket(string$bucketId, string$name, bool $fileSecurity, array $permissions = null, bool $enabled = null, int $maximumFileSize = null, array $allowedFileExtensions = null, bool $encryption = null, bool $antivirus = null): array
    {
        $path   = str_replace([], [], '/storage/buckets');
     ...
     */
    public function updateBucket(string$bucketId, string$name, bool $fileSecurity, array $permissions = null, bool $enabled = null, int $maximumFileSize = null, array $allowedFileExtensions = null, bool $encryption = null, bool $antivirus = null): array
    {
        $path   = str_replace(['{bucketId}'], [$bucketId], '/storage/buckets/{bucketId}');
